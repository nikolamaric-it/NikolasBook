...
class ContentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create content" do
    assert_difference('Content.count') do
      post contents_url, params: { content: { desc: @content.desc, price: @content.price, titolo: @content.titolo } }
    end
  ...
  test "should update content" do
    patch content_url(@content), params: { content: { desc: @content.desc, price: @content.price, titolo: @content.titolo } }
